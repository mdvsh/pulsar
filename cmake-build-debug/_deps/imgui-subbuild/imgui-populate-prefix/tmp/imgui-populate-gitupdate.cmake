...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "085781f5ca5372d5fc804d7e44b5bf27a8994af7"
  WORKING_DIRECTORY "/Users/sharmadhavs/Downloads/winter-24/498/pulsar3/cmake-build-debug/_deps/imgui-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "085781f5ca5372d5fc804d7e44b5bf27a8994af7")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("085781f5ca5372d5fc804d7e44b5bf27a8994af7" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/085781f5ca5372d5fc804d7e44b5bf27a8994af7")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"085781f5ca5372d5fc804d7e44b5bf27a8994af7\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/sharmadhavs/Downloads/winter-24/498/pulsar3/cmake-build-debug/_deps/imgui-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/sharmadhavs/Downloads/winter-24/498/pulsar3/cmake-build-debug/_deps/imgui-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()

//
// from https://github.com/BalazsJako/ImGuiColorTextEdit under MIT license
//
...
void TextEditor::SetSelection(const Coordinates & aStart, const Coordinates & aEnd, SelectionMode aMode)
{
  ...
  switch (aMode)
  {
    ...
    case TextEditor::SelectionMode::Line:
    {
      ...
      [[maybe_unused]] const auto lineSize = (size_t)lineNo < mLines.size() ? mLines[lineNo].size() : 0;
  ...
  if (mCheckComments)
  {
    ...
    while (static_cast<size_t>(currentLine) < endLine || currentIndex < endIndex)
    {
      ...
      if (!line.empty())
      {
        ...
        bool inComment = (commentStartLine < static_cast<size_t>(currentLine) || (commentStartLine == static_cast<size_t>(currentLine) && commentStartIndex <= currentIndex));
        ...
        else
        {
          ...
          else
          {
            ...
            inComment = inComment = (commentStartLine < static_cast<size_t>(currentLine) || (commentStartLine == static_cast<size_t>(currentLine) && commentStartIndex <= currentIndex));
